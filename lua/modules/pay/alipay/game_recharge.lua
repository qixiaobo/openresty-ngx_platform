...
--[[
    ...
    http://127.0.0.1/pay/alipay/game_recharge.do?
    amount=0.01&subject=test&return_url=&user_code=xxxx&auth_token=xxxx
	...
	local pay_data = { 
	    ...
	    notify_url = domain_url..alipay_conf.GAME_NOTIFY_URL, -- 异步通知地址
