...
--  作者:Steven 
--  日期:2017-02-26
--  文件名:/lua/modules/game/lottery/llc_player.lua
...
local BasePlayer = require "game.lottery.player" 
...
-- 继承
SSCPlayer.__index = SSCPlayer
setmetatable(SSCPlayer,BasePlayer)
...
SSCPlayer._VERSION = '0.01'            
SSCPlayer._CLAZZ = "game.lottery.player"  
...
function SSCPlayer:reset(_innings_no)
...
function SSCPlayer:init(_game_no_ex) 
...
function SSCPlayer:bet(_bet_money)
...
function SSCPlayer:on_heartbeat_c2s(_protocol) 
...
function SSCPlayer:on_heartbeat_s2c(_protocol)
...
function SSCPlayer:on_select_game_c2s(_protocol)
...
function SSCPlayer:on_select_game_s2c(_protocol)
...
function SSCPlayer:on_game_notice_s2c(_protocol)
...
function SSCPlayer:on_bet_c2s(_protocol)
...
function SSCPlayer:on_bet_s2c(_protocol)
...
function SSCPlayer:on_run_lot_c2s(_protocol)
...
function SSCPlayer:on_run_lot_s2c(_protocol)
...
--]]
function SSCPlayer:dispatch_protocol( _protocol )
    -- body
...
-- @param _protocol 协议格式
--]]
function SSCPlayer:bet_mysql( _bet_money )
...
-- @param  _bet_money 用户押注金额 
--]]
function SSCPlayer:rewards_mysql( _rewards_money )
